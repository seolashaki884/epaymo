"""
Django settings for epaymonia project.
...
SECRET_KEY = 'django-insecure-hc(=^0w&*0th4!^a^8_-l&86wuvdy0n3)yrta8(77px112vgqs'
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to the EPAYMO",
